...
*a_diab_treat				18y+ being treated for raised blood glucose or diabetes 
	...
	if inlist(name, "Azerbaijan2006") {	
		drop a_bp_treat a_bp_sys  a_bp_dial a_bp_meas a_bp_meas_ref a_hi_bp140 a_hi_bp140_or_on_med
		tempfile t1 t2
		preserve 
		...
		keep v001 v002 v003  a_bp_diag a_bp_treat a_bp_sys a_bp_dial a_hi_bp140 a_hi_bp140_or_on_med a_bp_meas a_bp_meas_ref
		ren (v001 v002 v003) (hv001 hv002 hvidx) 
		save `t2',replace 
		restore
	...
	if inlist(name, "Lesotho2009") {	
		drop a_diab_treat a_bp_treat a_bp_sys a_bp_dial a_bp_meas a_bp_meas_ref a_hi_bp140  a_hi_bp140_or_on_med
		tempfile t1 t2
		preserve 
		...
		keep v001 v002 v003 a_diab_diag a_diab_treat a_bp_diag a_bp_treat a_bp_sys a_bp_dial a_bp_meas a_bp_meas_ref a_hi_bp140 a_hi_bp140_or_on_med
		ren (v001 v002 v003) (hv001 hv002 hvidx) 
		save `t2',replace 
		restore
	...
	if inlist(name, "Ukraine2007") {	
		...
		keep v001 v002 v003 a_bp_diag a_bp_treat a_bp_sys a_bp_dial a_bp_meas a_bp_meas_ref a_hi_bp140 a_hi_bp140_or_on_med
		ren (v001 v002 v003) (hv001 hv002 hvidx) 
		save `t2',replace 
		restore
